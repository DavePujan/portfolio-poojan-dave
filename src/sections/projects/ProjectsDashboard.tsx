...
export default function ProjectsDashboard() {
  ...
  return (
    <section className="mx-auto w-full max-w-7xl px-4 py-14 sm:px-6 sm:py-20 md:px-10">
      <div className="mb-12 text-center">
        <p className="font-body text-xs uppercase tracking-[0.28em] text-neonGreen">Evidence-Led Engineering Work</p>
        <h1 className="mt-2 font-display text-3xl font-bold text-white sm:text-4xl md:text-6xl">Case Studies That Show How I Think</h1>
      ...
      <div className="mb-8 grid gap-3 rounded-2xl border border-white/15 bg-black/20 p-4 text-sm text-slate-200 sm:p-5 md:grid-cols-3">
