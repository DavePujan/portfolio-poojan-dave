...
const projects: ProjectCaseStudy[] = [
  ...
  {
    id: 'hls-stream',
    title: 'Event-Driven Video Processing Platform',
    tagline: 'Scalable cloud-native video transcoding system built with AWS services and asynchronous orchestration',
    summary:
      'A production-style media pipeline that uploads source video to S3, coordinates processing through SQS, runs isolated Dockerized FFmpeg workers on ECS Fargate, and publishes processed assets back to S3 for delivery.',
    category: 'System Design',
    tier: 'tier-3',
    tech: ['AWS SQS', 'AWS ECS Fargate', 'AWS S3', 'Docker', 'Node.js', 'TypeScript', 'FFmpeg', 'CloudWatch'],
    highlight: 'Event-driven processing with isolated transcoding containers and queue-based orchestration',
    impact:
      'Built a complete cloud-native media processing workflow capable of automatically scaling transcoding workloads while reducing infrastructure costs through serverless container orchestration.',
    monitoringFlowTitle: 'Processing Pipeline',
    overview:
      'A scalable cloud-native video processing platform that uses AWS S3, SQS, ECS Fargate, Docker, FFmpeg, and CloudWatch to create an event-driven transcoding workflow with fault isolation and production delivery.',
    coreFeatures: [
      {
        title: 'Event-Driven Processing',
        items: [
          'Automatic job creation through SQS message queues',
          'Asynchronous video processing workflow',
          'Decoupled upload and transcoding services',
        ],
      },
      {
        title: 'Containerized Transcoding',
        items: [
          'Dockerized FFmpeg workers',
          'On-demand ECS Fargate task execution',
          'Isolated processing environments for each job',
        ],
      },
      {
        title: 'Cloud Storage Pipeline',
        items: [
          'Source video retrieval from S3',
          'Processed video uploads to production S3 buckets',
    ...
    architectureFlow: [
      'Video Upload (AWS S3)',
      'SQS Job Creation',
      'SQS Consumer Service (Node.js)',
      'ECS RunTask Invocation',
      'Dockerized FFmpeg Worker',
      'Video Transcoding',
      'Processed Assets Upload (AWS S3)',
      'Cloud Delivery & Playback',
    ],
    asyncProcessing: ['SQS-based asynchronous job execution', 'Independent processing workers for parallel workloads', 'Decoupled architecture for improved fault isolation'],
    devOps: ['Dockerized deployment strategy', 'ECS Fargate orchestration', 'CloudWatch logging and monitoring', 'Environment-based configuration management'],
    testing: [
      'Queue message validation',
      'Error handling and retry mechanisms',
      'Successful task completion verification before queue acknowledgement',
      'End-to-end upload-to-transcode workflow testing',
    ],
    codeHighlights: ['src/index.ts', 'src/container/index.js', 'src/container/Dockerfile'],
    whatMakesItSpecial: [
      'Demonstrates distributed systems and event-driven architecture concepts.',
      'Showcases practical AWS cloud engineering experience.',
      'Covers backend development, DevOps, containerization, and media processing.',
      'Applies real-world scalability and reliability patterns used in production systems.',
    ],
    metrics: [
      {
        title: 'Scalable',
        description: 'Processes videos using on-demand ECS Fargate containers without maintaining dedicated servers.',
        tone: 'cyan',
      },
      {
        title: 'Cost Efficient',
        description: 'Eliminates idle infrastructure by launching compute resources only when processing jobs exist.',
        tone: 'green',
      },
      {
        title: 'Reliable',
        description: 'Queue-based architecture ensures jobs are tracked, retried, and processed independently.',
        tone: 'blue',
      },
    ],
    requestLifecycle: [
      'User uploads a video to an S3 bucket.',
      'Upload event generates a processing job in SQS.',
      'Node.js consumer polls the queue and receives the job.',
      'ECS RunTask launches a dedicated Dockerized FFmpeg worker.',
      'Worker downloads the source video from S3.',
      'FFmpeg performs video transcoding.',
      'Output files are uploaded to production S3 storage.',
      'Logs and execution details are tracked through CloudWatch.',
    ],
    keyLearnings: [
      'Event-driven architectures simplify scalable background processing.',
      'Container orchestration enables efficient resource utilization.',
      'Queue-based systems improve reliability and fault tolerance.',
      'Cloud-native workflows reduce operational overhead while supporting growth.',
    ],
    links: {
    ...
    evidence: [
      {
        title: 'Diagram',
        caption: 'Event-driven upload to SQS, ECS, and S3 processing flow.',
        src: '/hls/hls_01.png',
      },
      {
        title: 'Building And Running Docker Container',
        caption: 'Local container execution for the FFmpeg worker pipeline.',
        src: '/hls/hls_02.png',
      },
      {
        title: 'AWS S3 Console With File Upload',
        caption: 'Source asset uploaded to the S3 bucket to trigger the workflow.',
        src: '/hls/hls_03.png',
      },
      {
        title: 'Amazon ECR Task Management Dashboard',
        caption: 'ECS task and repository view used to manage container execution.',
        src: '/hls/hls_04.png',
      },
      {
        title: 'Checking Transcoded Videos In AWS S3',
        caption: 'Validation of processed media in the production S3 bucket.',
        src: '/hls/hls_05.png',
      },
      {
    ...
    resumeVersion:
      'Built a scalable video processing platform using AWS SQS, ECS Fargate, Docker, FFmpeg, and S3, implementing event-driven transcoding, automated cloud orchestration, fault-tolerant job processing, and cost-efficient serverless infrastructure.',
    finalVerdict: 'A strong backend and cloud engineering project demonstrating distributed systems design, AWS cloud infrastructure, and scalable media processing.',
    finalVerdictPoints: [
